...
<body id="page-top">
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                {{-- TOPBAR TETAP DI SINI ATAU BISA DI-INCLUDE JUGA --}}
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                ...
                                <a class="dropdown-item" href="{{ route('dashboard.resetPassword') }}">
                                    <i class="fas fa-key fa-sm fa-fw mr-2 text-gray-400"></i> Reset Password
                                </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Praktek RPL 2026</span>
                    </div>
                </div>
            </footer>
        </div>
